...
const getIndexPage = async(req,res) => {
    const photos = await Photo.find().sort({uploudAt:-1}).limit(3);
    ...
    try{
        let transporter = nodemailer.createTransport({
          ...
          // send mail with defined transport object
            ...
            to: "muradrashidov995@gmail.com", // list of receivers
...
export {
    getIndexPage,getAboutPage,getRegisterPage,getLoginPage,getLogout,getContactPage,sendMail
}
